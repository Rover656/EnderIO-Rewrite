...
public class EIOLang {
    ...
    public static final Component CAPACITOR_ALL_ENERGY_CONSUMPSTION = capacitorDescriptionBuilder("type", CapacitorSpecializations.ALL_ENERGY_CONSUMPTION.getPath(), "Leaky");
    public static final Component CAPACITOR_ALL_PRODUCTION_SPEED = capacitorDescriptionBuilder("type", CapacitorSpecializations.ALL_PRODUCTION_SPEED.getPath(), "Fast");
    public static final Component CAPACITOR_ALLOY_ENERGY_CONSUMPSTION = capacitorDescriptionBuilder("type", CapacitorSpecializations.ALLOY_ENERGY_CONSUMPTION.getPath(),
        "Melted");
    public static final Component CAPACITOR_ALLOY_PRODUCTION_SPEED = capacitorDescriptionBuilder("type", CapacitorSpecializations.ALLOY_PRODUCTION_SPEED.getPath(), "Smelting");
